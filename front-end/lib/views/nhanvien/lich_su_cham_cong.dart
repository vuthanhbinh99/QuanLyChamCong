...
class LichSuChamCongView extends StatefulWidget {
  final String userId;

  const LichSuChamCongView({super.key, required this.userId});

  @override
  _LichSuChamCongViewState createState() => _LichSuChamCongViewState();
}

class _LichSuChamCongViewState extends State<LichSuChamCongView> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      // Load chấm công
      final records = await apiService.getChamCongByUserId(widget.userId);
      setState(() {
        _allRecords = records;
        _applyFilter();
        _isLoading = false;
                  ...
                  children: [
                    Expanded(
                      child: ElevatedButton.icon(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor: _filterType == 'day' ? Colors.blue : Colors.grey[300],
                    ...
                    Expanded(
                      child: ElevatedButton.icon(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor: _filterType == 'month' ? Colors.blue : Colors.grey[300],
                    ...
                    Expanded(
                      child: ElevatedButton.icon(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor: _filterType == 'year' ? Colors.blue : Colors.grey[300],
                    ...
                    Wrap(
                      ...
                      children: _getShiftStatistics().entries.map((entry) {
                        ...
                        return _buildShiftStat(
                          // ✅ FIX dòng 172: Cast an toàn
                          shiftInfo['name'] as String,
                          entry.value.toString(),
                          // ✅ FIX dòng 178: Cast an toàn
                          shiftInfo['icon'] as IconData,
                          // ✅ FIX dòng 180: Cast an toàn
